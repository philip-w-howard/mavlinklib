...
#define MAVLINK_MSG_ID_GIMBAL_SET_FACTORY_PARAMETERS_CRC 223
#define MAVLINK_MSG_ID_206_CRC 223
...
#define MAVLINK_MESSAGE_INFO_GIMBAL_SET_FACTORY_PARAMETERS { \
	...
	14, \
	{  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gimbal_set_factory_parameters_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_gimbal_set_factory_parameters_t, target_component) }, \
         { "magic_1", NULL, MAVLINK_TYPE_UINT32_T, 0, 2, offsetof(mavlink_gimbal_set_factory_parameters_t, magic_1) }, \
         { "magic_2", NULL, MAVLINK_TYPE_UINT32_T, 0, 6, offsetof(mavlink_gimbal_set_factory_parameters_t, magic_2) }, \
         { "magic_3", NULL, MAVLINK_TYPE_UINT32_T, 0, 10, offsetof(mavlink_gimbal_set_factory_parameters_t, magic_3) }, \
         { "assembly_year", NULL, MAVLINK_TYPE_UINT16_T, 0, 14, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_year) }, \
         { "assembly_month", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_month) }, \
         { "assembly_day", NULL, MAVLINK_TYPE_UINT8_T, 0, 17, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_day) }, \
         { "assembly_hour", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_hour) }, \
         { "assembly_minute", NULL, MAVLINK_TYPE_UINT8_T, 0, 19, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_minute) }, \
         { "assembly_second", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_gimbal_set_factory_parameters_t, assembly_second) }, \
         { "serial_number_pt_1", NULL, MAVLINK_TYPE_UINT32_T, 0, 21, offsetof(mavlink_gimbal_set_factory_parameters_t, serial_number_pt_1) }, \
         { "serial_number_pt_2", NULL, MAVLINK_TYPE_UINT32_T, 0, 25, offsetof(mavlink_gimbal_set_factory_parameters_t, serial_number_pt_2) }, \
         { "serial_number_pt_3", NULL, MAVLINK_TYPE_UINT32_T, 0, 29, offsetof(mavlink_gimbal_set_factory_parameters_t, serial_number_pt_3) }, \
         } \
}
						       ...
						       uint8_t target_system, uint8_t target_component, uint32_t magic_1, uint32_t magic_2, uint32_t magic_3, uint16_t assembly_year, uint8_t assembly_month, uint8_t assembly_day, uint8_t assembly_hour, uint8_t assembly_minute, uint8_t assembly_second, uint32_t serial_number_pt_1, uint32_t serial_number_pt_2, uint32_t serial_number_pt_3)
{
	...
	_mav_put_uint32_t(buf, 2, magic_1);
	_mav_put_uint32_t(buf, 6, magic_2);
	_mav_put_uint32_t(buf, 10, magic_3);
	_mav_put_uint16_t(buf, 14, assembly_year);
	_mav_put_uint8_t(buf, 16, assembly_month);
	_mav_put_uint8_t(buf, 17, assembly_day);
	_mav_put_uint8_t(buf, 18, assembly_hour);
	_mav_put_uint8_t(buf, 19, assembly_minute);
	_mav_put_uint8_t(buf, 20, assembly_second);
	_mav_put_uint32_t(buf, 21, serial_number_pt_1);
	_mav_put_uint32_t(buf, 25, serial_number_pt_2);
	_mav_put_uint32_t(buf, 29, serial_number_pt_3);
...
{
	return _MAV_RETURN_uint32_t(msg,  21);
}

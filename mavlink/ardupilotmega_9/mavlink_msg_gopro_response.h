...
#define MAVLINK_MSG_ID_GOPRO_RESPONSE_CRC 235
#define MAVLINK_MSG_ID_218_CRC 235
...
#define MAVLINK_MESSAGE_INFO_GOPRO_RESPONSE { \
	"GOPRO_RESPONSE", \
	5, \
	{  { "gp_cmd_name_1", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gopro_response_t, gp_cmd_name_1) }, \
         { "gp_cmd_name_2", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_gopro_response_t, gp_cmd_name_2) }, \
         { "gp_cmd_response_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_gopro_response_t, gp_cmd_response_status) }, \
         { "gp_cmd_response_argument", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_gopro_response_t, gp_cmd_response_argument) }, \
         { "gp_cmd_result", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_gopro_response_t, gp_cmd_result) }, \
         } \
}
						       ...
						       uint8_t gp_cmd_name_1, uint8_t gp_cmd_name_2, uint8_t gp_cmd_response_status, uint8_t gp_cmd_response_argument, uint16_t gp_cmd_result)
{
	...
	_mav_put_uint8_t(buf, 0, gp_cmd_name_1);
	_mav_put_uint8_t(buf, 1, gp_cmd_name_2);
	_mav_put_uint8_t(buf, 2, gp_cmd_response_status);
	_mav_put_uint8_t(buf, 3, gp_cmd_response_argument);
	_mav_put_uint16_t(buf, 4, gp_cmd_result);

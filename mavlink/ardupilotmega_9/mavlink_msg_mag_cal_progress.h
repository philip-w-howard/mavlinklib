...
#define MAVLINK_MSG_ID_MAG_CAL_PROGRESS_CRC 0
#define MAVLINK_MSG_ID_191_CRC 0
...
#define MAVLINK_MESSAGE_INFO_MAG_CAL_PROGRESS { \
	"MAG_CAL_PROGRESS", \
	9, \
	{  { "compass_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mag_cal_progress_t, compass_id) }, \
         { "cal_mask", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_mag_cal_progress_t, cal_mask) }, \
         { "cal_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mag_cal_progress_t, cal_status) }, \
         { "attempt", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_mag_cal_progress_t, attempt) }, \
         { "completion_pct", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mag_cal_progress_t, completion_pct) }, \
         { "completion_mask", NULL, MAVLINK_TYPE_UINT8_T, 10, 5, offsetof(mavlink_mag_cal_progress_t, completion_mask) }, \
         { "direction_x", NULL, MAVLINK_TYPE_FLOAT, 0, 15, offsetof(mavlink_mag_cal_progress_t, direction_x) }, \
         { "direction_y", NULL, MAVLINK_TYPE_FLOAT, 0, 19, offsetof(mavlink_mag_cal_progress_t, direction_y) }, \
         { "direction_z", NULL, MAVLINK_TYPE_FLOAT, 0, 23, offsetof(mavlink_mag_cal_progress_t, direction_z) }, \
         } \
}
						       ...
						       uint8_t compass_id, uint8_t cal_mask, uint8_t cal_status, uint8_t attempt, uint8_t completion_pct, const uint8_t *completion_mask, float direction_x, float direction_y, float direction_z)
{
	...
	_mav_put_uint8_t(buf, 3, attempt);
	_mav_put_uint8_t(buf, 4, completion_pct);
	_mav_put_float(buf, 15, direction_x);
	_mav_put_float(buf, 19, direction_y);
	_mav_put_float(buf, 23, direction_z);
	_mav_put_uint8_t_array(buf, 5, completion_mask, 10);
...
{
	return _MAV_RETURN_uint8_t_array(msg, completion_mask, 10,  5);
}
